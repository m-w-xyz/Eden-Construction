  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-8 px-[10px] pt-[10px] pb-[120px] max-md:grid-cols-1 max-md:gap-6 max-md:pb-8">
        <p className="text-base md:text-[20px] md:leading-[20px] max-md:mb-0">Solutions-based Building</p>
        <div className="flex min-w-0 max-md:flex-col max-md:gap-6">
          <div className="flex flex-1 min-w-0 flex-col items-start justify-start gap-0 font-normal">
            <p className="w-full text-base md:text-[20px] md:leading-[20px]">Pacific Harbour, Fiji</p>
          </div>
          <div className="flex flex-1 min-w-0 flex-col items-start justify-start gap-0 font-normal max-md:gap-0">
            <p className="mb-0">
              <a href="mailto:finn@edenconstruction.org" className="text-base md:text-[20px] md:leading-[20px] hover:opacity-50 transition-opacity inline-block py-0">
            ...
            <p className="mb-0">
              <a
                ...
                className="text-base md:text-[20px] md:leading-[20px] hover:opacity-50 transition-opacity inline-block py-0"
              >
                Facebook
              </a>
            </p>
